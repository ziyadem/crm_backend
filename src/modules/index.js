...
router.put(
  ...
  router.post("/payment", tokenAdminMdw, postCreatePayment);
  router.post("/paid", tokenAdminMdw, getMonthPayment);
  router.post("/grouppayment", tokenAdminMdw, getPaymentStudentGroup);

  router.post("/attendance", tokenAdminMdw, postCreateAttendance);
  router.post("/attendancenot", tokenAdminMdw, getNotAttendance);
